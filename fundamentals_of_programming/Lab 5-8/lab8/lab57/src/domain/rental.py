...
class rental:
    ...
    def cStr(self):
        if(str(self.__returnedDate)=="Not returned yet"):
            ...
            x=str(self.__returnedDate.strftime('%Y-%m-%d'))
        return str(self.__rentalID)+','+str(self.__bookID)+','+str(self.__clientID)+','+str(self.__rentedDate.strftime('%Y-%m-%d'))+','+str(self.__dueDate.strftime('%Y-%m-%d'))+','+x                        
