...
class controller:
    ...
    def __searchBooksByID(self,ID):#returns the books with a given ID
        for i in range(0,len(self.__Books)):
            if(self.__Books.get(i).getID()==ID):
                return str(self.__Books.get(i))
        return ("No books with ID="+str(ID))
    
    def __searchBooksByTitle(self,title):#returns all books with a given title
        s=""
        for i in range(0,len(self.__Books)):
            if((self.__Books.get(i).getTitle().lower() in title.lower()) or (title.lower() in self.__Books.get(i).getTitle().lower()) ):
                s+=str(self.__Books.get(i))
                s+="\n"
        if(s==""):
    ...
    def __searchBooksByAuthor(self,author):#returns all books with a given author
        s=""
        for i in range(0,len(self.__Books)):
            if((self.__Books.get(i).getAuthor().lower() in author.lower()) or(author.lower() in self.__Books.get(i).getAuthor().lower()) ):
                s+=str(self.__Books.get(i))
                s+="\n"
        if(s==""):
    ...
    def __searchBooksByDescription(self,description):#returns all books with a given description
        s=""
        for i in range(0,len(self.__Books)):
            if((self.__Books.get(i).getDescription().lower() in description.lower()) or(description.lower() in self.__Books.get(i).getDescription().lower()) ):
                s+=str(self.__Books.get(i))
                s+="\n"
        if(s==""):
    ...
    def __searchClientsByID(self,ID):#returns client with a given ID
        for i in range(0,len(self.__Clients)):
            if(self.__Clients.get(i).getID()==ID):
                return str(self.__Clients.get(i))
        return ("No clients with ID="+str(ID))
    
    def __searchClientsByName(self,name):#returns all clients with a given name
        s=""
        for i in range(0,len(self.__Clients)):
            if((name.lower() in self.__Clients.get(i).getName().lower()) or (self.__Clients.get(i).getName()).lower() in name.lower()):
                s+=str(self.__Clients.get(i))
                s+="\n"
        if(s==""):
